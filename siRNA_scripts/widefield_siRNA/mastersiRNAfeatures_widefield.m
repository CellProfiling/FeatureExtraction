function mastersiRNAfeatures_widefield
%This function loops through the siRNA examples and extracts features
%
%Written by: Devin P Sullivan 05,08,2015
%
%Updated by: 
%D.P. Sullivan 23,05,2018 -- adapted for widefield DMI8 microscope

addpath(genpath('/Users/devinsullivan/Documents/production/confocal/'));
...
infolder = '/Volumes/DevinsStorage/siRNA_DMI8/';
...
%default: pwd
outfolder = ['/Users/devinsullivan/Documents/production/widefield_siRNA/features_out',strrep(date,'-','')];
...
%default: THIS IS REQUIRED. THERE IS NO DEFAULT FOR THIS VARIABLE
resolution = 0.16;%10x I guess, I thought it would be 40x
